...
TOOLS = [
    {
        "type": "function",
        "function": {
            "description": """Opens a specified URL in the web browser instance. \
Returns url of the new page if successful or appropriate error message if the page could not be opened. \
Do not use for PDFs, use the `get_webpage_info` tool instead along with your query for what you want to find on the page.
""",
            "name": "openurl",
            "parameters": {
                "type": "object",
...
The DOM representation returned contains items ordered in the same way they appear on the page. \
Keep this in mind when executing user requests that contain ordinals or numbered items. \
The content_type parameter specifies the type of content to extract and can be set for \
full text of the page, input fields of the page, or all fields of the page. \
If information is not available in one content_type, you must try another content_type.""",
            ...
            "parameters": {
                ...
                "properties": {
                    "content_type": {
                        "type": "string",
                        "description": """The type of content to extract, valid options are:
...
all_fields - returns a JSON string containing a list of objects representing all interactive elements and their attributes with mmid attribute. Use this strictly to identify and interact with any type of elements on page.""",
    ...
    },
    {
        "type": "function",
        "function": {
            "description": "Executes a click action on the element matching the given mmid attribute value. It is best to use mmid attribute as the selector. Returns Success if click was successful or appropriate error message if the element could not be clicked.",
            "name": "click",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        "type": "function",
        "function": {
            "description": "Bulk enter text in multiple DOM fields. To be used when there are multiple fields to be filled on the same page. Enters text in the DOM elements matching the given mmid attribute value. The input will receive a list of objects containing the DOM query selector and the text to enter. This will only enter the text and not press enter or anything else. Returns each selector and the result for attempting to enter text.",
    ...
    },
    {
        "type": "function",
        "function": {
            "description": "Presses the given key on the current web page. This is useful for pressing the enter button to submit a search query, PageDown to scroll, ArrowDown to change selection in a focussed list etc.",
